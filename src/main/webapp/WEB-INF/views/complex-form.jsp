...
<body class="" style="background: #e2e2e2;">
    ...
    <select name="course" class="form-control" id="exampleFormControlSelect1" multiple>
        ...
        <option value="Hibernate">Hibernate</option>
							...
							<p>your address</p>
							<div class="form-group" >
							<input type="text" class="form-control" placeholder="Enter Your Street" name="address.street"/>
							<input type="text" class="form-control" placeholder="Enter Your City" name="address.city"/>
							</div>
							</div>
